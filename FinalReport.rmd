...
As we look at the table the results showed us that those that took the treatment with drug had a 48% percent catching aids, and the ones that took the placebo cough aids 41%. We can see that the ones that took the placebo had a rely low chance of getting aids, then those that took the drug.

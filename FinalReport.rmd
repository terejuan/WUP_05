...
In conclusion as we worked trough the data and the fisher test, we immediately notice that this clinical trial on females catching aids if they took the drug was a fail. We notice that females  that took the drug did in fact catch Aids and those that took the placebo didn't. As we looked at the table we see that almost 60% of the 100% that took the drug got infected with aids, and only 40% didn't. The fisher test showed us that you are more likely to catch aid if you take the drug then if you take the placebo. That's a chance that now one would like to take based on this test, the clinical trial was a fail.
